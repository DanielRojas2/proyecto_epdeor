...
class CargoAdmin(admin.ModelAdmin):
    list_display = ('cargo', 'departamento', 'unidad', 'rol', 'creado', 'actualizado')
    search_fields = ('cargo', 'departamento__departamento', 'unidad__unidad', 'rol__rol')
    list_filter = ('departamento', 'unidad', 'rol')
    ordering = ('cargo',)
